...
def profile_philo(request):
    profiles = profile_phil.objects.all()
    context = {
        'profiles':profiles
    }
    return render(request,'ashrayapp/profile_philo.html',context)
...
def don_philo(request):
    return render(request,'ashrayapp/donphilo.html')

def addevephilo(request):
    return render(request,'ashrayapp/addevephilo.html')

def newsphilo(request):
    return render(request,'ashrayapp/newsphilo.html')

def eventphilo(request):
    return render(request,'ashrayapp/eventphilo.html')

def payphilo(request):
    return render(request,'ashrayapp/payphilo.html')

def chatphilo(request):
    return render(request,'ashrayapp/chatphilo.html')

def phil_up(request):
    return render(request,'ashrayapp/phil_up.html')